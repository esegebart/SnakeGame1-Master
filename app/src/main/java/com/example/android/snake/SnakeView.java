...
public class SnakeView extends TileView {
    ...
    public void setSnakeMovementListener(SnakeMovementListener snakeMovementListener) {
        this.snakeMovementListener = snakeMovementListener;
    }

    /**Add an interface to define function*/
    ...
    /**Method to check if the snakeMovementListener is null*/
